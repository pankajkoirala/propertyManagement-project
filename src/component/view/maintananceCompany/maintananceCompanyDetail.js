...
let showHide=()=>{
  ...
  return (
    <div>
      {showEditForm===false? props.selectedMaintananceCompany.map((arg, index) => {
        return (
          <div key={index} className="property-card">
            <div className="card-contents">
              ...
              <button className="danger ml-2" onClick={()=>{props.maintananceCompanyDelete(arg._id)}}>Delete</button>
